...
class CategoryEndpointsTest extends TestCase
{
    ...
    public function test_can_create_category(): void
    {
        ...
        $this->withSession(['critical_actions' => [\App\Modules\Access\Domain\Authorization\CriticalAction::CATEGORY_CREATE->value => time()]]);
    ...
    public function test_can_publish_category_version(): void
    {
        ...
        $this->withSession(['critical_actions' => [
            \App\Modules\Access\Domain\Authorization\CriticalAction::CATEGORY_CREATE->value => time(),
            \App\Modules\Access\Domain\Authorization\CriticalAction::CATEGORY_VERSION_PUBLISH->value => time(),
        ]]);
