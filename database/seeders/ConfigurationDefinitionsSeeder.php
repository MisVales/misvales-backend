...
final class ConfigurationDefinitionsSeeder extends Seeder
{
    ...
    public static function definitions(): array
    {
        return [
            ...
            ['key' => 'VERIFICATION_START_TIME', 'name' => 'Hora verificador mínima', 'description' => 'Primera hora global disponible para asignar e iniciar una visita de verificación.', 'value_type' => 'TIME', 'unit' => null],
            ['key' => 'VERIFICATION_MAX_START_TIME', 'name' => 'Hora verificador máxima', 'description' => 'Última hora global disponible para asignar e iniciar una visita de verificación.', 'value_type' => 'TIME', 'unit' => null],
