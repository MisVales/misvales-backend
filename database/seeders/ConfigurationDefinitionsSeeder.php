...
final class ConfigurationDefinitionsSeeder extends Seeder
{
    ...
    public static function definitions(): array
    {
        return [
            ...
            ['key' => 'VERIFICATION_START_TIME', 'name' => 'Hora inicio de visitas', 'description' => 'Primera hora global disponible para asignar e iniciar una visita de verificación.', 'value_type' => 'TIME', 'unit' => null],
            ['key' => 'VERIFICATION_MAX_START_TIME', 'name' => 'Hora final de visitas', 'description' => 'Última hora global disponible para asignar e iniciar una visita de verificación.', 'value_type' => 'TIME', 'unit' => null],
            ...
            ['key' => 'LATE_FEE_AMOUNT', 'name' => 'Recargo global por relación', 'description' => 'Importe único aplicado cuando una relación vence con saldo pendiente.', 'value_type' => 'DECIMAL', 'unit' => 'MXN'],
