        ...
        foreach ($roles as $roleData) {
            ...
            if (in_array($roleData['code'], ['admin', 'branch_manager'], true)) {
                $permissionCodes = $roleData['code'] === 'branch_manager'
                    ? ['users.view', 'roles.view', 'roles.assign', 'branches.view', 'assignments.manage', 'distributor_applications.view', 'distributor_applications.view_sensitive', 'distributor_applications.update', 'distributor_applications.submit']
