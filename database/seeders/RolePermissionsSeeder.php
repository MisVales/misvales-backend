    ...
    private function matrix(array $allPermissionCodes): array
    {
        return [
            ...
            'branch_manager' => [
                ...
                'points.view_branch', 'points.authorize_branch', 'points.deliver_branch',
                'bank_imports.view_branch', 'bank_movements.view_branch', 'payment_clarifications.view_branch',
                'manual_reconciliation.view_branch', 'manual_reconciliation.authorize_branch', 'surpluses.view_branch',
            ...
            'distributor' => [
                ...
                'points.view_own', 'points.request_own',
                'relations.download_own', 'payment_clarifications.create_own', 'payment_clarifications.view_own', 'surpluses.view_own',
                'risk.view_own',
                'notifications.view_own', 'media.upload',
            ],
            'cashier' => [
                'vouchers.view_branch', 'vouchers.cash_branch', 'relations.view_branch',
                'points.view_branch', 'points.deliver_branch',
                'bank_imports.create_branch', 'bank_imports.view_branch', 'bank_movements.view_branch',
                'payment_clarifications.view_branch', 'manual_reconciliation.view_branch',
