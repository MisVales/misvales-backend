...
class AssignCategoryHandler
{
    ...
    public function handle(
        ...
        return DB::transaction(function () use (
            ...
            // Validar que no tenga categoría vigente
            $hasActiveCategory = DistributorCategoryAssignment::where('distributor_id', $distributorId)
            ...
            // Crear asignación
            $now = now();
            $assignment = DistributorCategoryAssignment::create([
            ...
            // Registrar evento DistributorCategoryAssigned (Pendiente por M18)
