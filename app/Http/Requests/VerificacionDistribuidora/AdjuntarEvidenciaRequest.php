...
class AdjuntarEvidenciaRequest extends FormRequest {
    ...
    protected function failedValidation(Validator $validator) {
        ...
        if ($errors->has('file')) {
            ...
            if (isset($failed['Max'])) throw new BusinessException('VERIFICATION_EVIDENCE_TOO_LARGE', 'Archivo excede límite.', 422);
            if (isset($failed['Mimes'])) throw new BusinessException('VERIFICATION_EVIDENCE_MIME_INVALID', 'Mime type inválido.', 422);
