...
use App\Modules\Client\Application\Queries\EloquentClientVersionReader;
...
final class ClientServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->bind(CorrectableClientFieldRegistry::class, DefaultCorrectableClientFieldRegistry::class);
        $this->app->bind(ClientVersionReader::class, EloquentClientVersionReader::class);
